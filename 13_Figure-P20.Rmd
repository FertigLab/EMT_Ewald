...
```{r loadData}
load("~/Documents/Hopkins/Ewald/EMT_Ewald-main/data/cellCycle_EJFPsuedotimeResults2Mar2020.Rda")
## Load the CoGAPS 20 Pattern Result
cogapsRes <- readRDS("~/Documents/Hopkins/Ewald/EMT_Ewald-main/cogaps/gwCogapsRes/emtGwCogaps_20.rds")
## Load the pathways results for the emt pathway
emtPatterns <- read.csv(file = "~/Downloads/emtResults-p20.csv", header = TRUE)
## Load the pattern markers
patternMarkerResults <- read.csv(file = "~/Documents/Hopkins/Ewald/EMT_Ewald-main/patternMarkers_emtGwCogaps_20.csv")
## Load the EMT genes
emtGenes <- read.csv("~/Documents/Hopkins/Ewald/EMT_Ewald-main/data/geneList.csv", header = FALSE)
```
...
emtPatterns <- read.csv("~/Downloads/emtResults-p20.csv")
...
small_mat <- matrix("", nrow = 34, ncol= 4)
...
# pdf("~/Documents/Hopkins/Ewald/EMT_Ewald-main/emtGeneUmaps-P20.pdf")
