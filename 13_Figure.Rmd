...
scaled.data<- t(apply(cogapsRes@featureLoadings, 1, scale))
## Extract the amplitude matrix while dropping the cell line patterns
amplitude <- scaled.data[rownames(cogapsRes@featureLoadings) %in% emtGenes$V1, 
    colnames(cogapsRes@featureLoadings) %in%c("Pattern_5","Pattern_8","Pattern_18", "Pattern_14")]
## Reorder the scaledmat
scaledmat <- amplitude[, c(1, 2, 4, 3)] 

##Reassign the column names
colnames(scaledmat) <-c("Pattern_5","Pattern_8","Pattern_18","Pattern_14")
...
## Create the heatmap
Heatmap(t(scaledmat),name = "Amplitude", col=col_fun, cluster_columns = TRUE,
        show_row_dend = FALSE, 
